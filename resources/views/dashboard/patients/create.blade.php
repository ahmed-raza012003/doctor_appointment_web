    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.patients.store') }}" enctype="multipart/form-data" id="patientForm">
                    @csrf
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary" style="background-color: #11849B; border-color: #11849B;">Create Patient</button>
                </form>
            </div>
        </div>
    </div>
