...
@section('content')
                            ...
                            <div id="profileImage" class="accordion-collapse collapse" data-bs-parent="#doctorFormAccordion">
                                <div class="accordion-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="drop-zone text-center p-3 bg-light border border-2 border-dashed border-theme rounded">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (categorySelect) {
                categorySelect.addEventListener('change', function() {
                    ...
                    specTiles.forEach(tile => {
                        tile.style.display = (selectedCategory === 'all' || tile.getAttribute('data-category') === selectedCategory) ? 'block' : 'none';
                    });
                ...
                educationDiv.innerHTML = `
                    <div class="row g-3 align-items-end">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="education_degree_${educationCount}" name="education[${educationCount - 1}][degree]" value="${degree}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="education_institution_${educationCount}" name="education[${educationCount - 1}][institution]" value="${institution}" required>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control" id="education_year_${educationCount}" name="education[${educationCount - 1}][year]" value="${year}">
            ...
            // Add initial education field and set up addEducation button
