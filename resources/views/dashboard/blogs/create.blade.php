    ...
    <div class="container-fluid">
        <div class="card shadow-sm">
            <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-3">Add Blog</h5>
                <form method="POST" action="{{ route('admin.blogs.store') }}" enctype="multipart/form-data" id="blogForm">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-2">
                                ...
                                <textarea class="form-control @error('description_card') is-invalid @enderror" id="description_card" name="description_card" rows="4">{{ old('description_card') }}</textarea>
                            ...
                            <div class="mb-2">
                                ...
                                <textarea class="form-control @error('description_page') is-invalid @enderror" id="description_page" name="description_page" rows="4">{{ old('description_page') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="drop-zone text-center p-2" id="featureDropZone" style="background-color: #11849B; border: 2px dashed #ffffff; border-radius: 4px; color: #ffffff;">
                                    ...
                                    <span id="featureFileName" class="text-white small mt-1 d-block">No file chosen</span>
                                    <input type="file" id="feature_image" name="feature_image" class="d-none" accept="image/*" required>
                                </div>
                                @error('feature_image')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="drop-zone text-center p-2" id="desc1DropZone" style="background-color: #11849B; border: 2px dashed #ffffff; border-radius: 4px; color: #ffffff;">
                                    ...
                                    <span id="desc1FileName" class="text-white small mt-1 d-block">No file chosen</span>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="drop-zone text-center p-2" id="desc2DropZone" style="background-color: #11849B; border: 2px dashed #ffffff; border-radius: 4px; color: #ffffff;">
                                    ...
                                    <span id="desc2FileName" class="text-white small mt-1 d-block">No file chosen</span>
                    ...
                    <button type="submit" class="btn btn-primary px-4" style="background-color: #11849B; border-color: #11849B;">Create Blog</button>
